...
describe('CdkContextMenuTrigger', () => {
  describe('with simple context menu trigger', () => {
    ...
    it('should display context menu on right click inside of specified component', () => {
    ...
    it('should close context menu on right click inside the open menu', () => {
      openContextMenu();
      expect(getNativeContextMenu()).toBeDefined();
...
@Component({
  template: `
    <div #cut_trigger [cdkContextMenuTriggerFor]="cut">
      <div #copy_trigger [cdkContextMenuTriggerFor]="copy"></div>
    </div>
